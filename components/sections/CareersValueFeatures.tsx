...
import {
  defaultCareersFeatures,
  sectionItemsOrDefault,
  type CmsFeatureItem,
} from "../../lib/cms-items";

const tones = ["bone", "sprout", "moss", "honey"] as const;

const icons = [
  <svg key="home" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
  ...
  <svg key="clear" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
  ...
  <svg key="paths" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
  ...
  <svg key="apply" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
...
export function CareersValueFeatures({
  ...
  return (
    <section
      data-cms-section="careers-features"

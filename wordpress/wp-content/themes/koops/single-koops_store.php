...
<main id="turinys" class="dark-page single-store">
    <section class="detail-hero shell">
        ...
        <?php $image = koops_post_image($id, 'koops-hero', 'koops-bento-local-shopping.jpg'); ?><img class="rounded-media reveal" src="<?php echo esc_url($image); ?>" alt="Parduotuvė „<?php echo esc_attr(get_the_title()); ?>“">
    </section>
